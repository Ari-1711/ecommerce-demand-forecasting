  ...
  if (active && payload && payload.length) {
    ...
    return (
      <div className="bg-slate-900 border border-slate-700/90 p-3 rounded-lg shadow-xl text-xs">
        <div className="font-semibold text-slate-100 mb-1.5 flex items-center justify-between gap-3 border-b border-slate-800 pb-1.5">
          <span className="font-mono text-white">StockCode: {label}</span>
...
export default function ParetoChart({ data, loading }) {
  if (loading) {
    return (
      <div className="saas-card p-5 rounded-xl h-[400px] flex flex-col justify-between animate-pulse">
  ...
  return (
    <div className="saas-card p-5 rounded-xl flex flex-col h-[400px]">
      <div className="flex items-center justify-between mb-3">
        ...
        <div className="flex items-center space-x-3 text-xs">
          <div className="flex items-center gap-1.5">
            ...
            <span className="text-slate-300 text-[11px]">Demand</span>
          </div>
          <div className="flex items-center gap-1.5">
            <span className="w-3 h-0.5 bg-amber-400 inline-block"></span>
            <span className="text-slate-300 text-[11px]">Kumulatif %</span>
          </div>
        </div>
      </div>
